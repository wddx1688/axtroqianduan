        ...
        <div className="theme-container mx-auto">
          <div className="w-full">
            <div className="title flex justify-between items-center gap-2 flex-wrap w-full">
              ...
              <div>
                <Link href={url}>
                  <div className="lg:py-4 lg:px-[25px] py-3 px-5 inline-flex rtl:space-x-reverse space-x-2.5 items-center bg-primary-blue hover:bg-white common-transition rounded-[5px]">
